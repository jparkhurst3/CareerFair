...
enum states {SPLASH, L1INSTRUCTIONS, LEVELONE, PAUSE, L1WIN, L1LOSE, L2INSTRUCTIONS, LEVELTWO, L2WIN, L2LOSE, GOODRECRUITER};
...
# 1 "l1LoseImage.h" 1
# 21 "l1LoseImage.h"
extern const unsigned short l1LoseImageBitmap[19200];


extern const unsigned short l1LoseImagePal[256];
# 4 "l2Lose.c" 2
