...
# 3 "levelOne.c" 2
# 1 "levelOneCloserImage.h" 1
# 22 "levelOneCloserImage.h"
extern const unsigned short levelOneCloserImageTiles[5712];


extern const unsigned short levelOneCloserImageMap[2048];


extern const unsigned short levelOneCloserImagePal[256];
# 4 "levelOne.c" 2
# 1 "levelOneFurtherImage.h" 1
# 21 "levelOneFurtherImage.h"
extern const unsigned short levelOneFurtherImageTiles[4832];


extern const unsigned short levelOneFurtherImageMap[2048];
# 5 "levelOne.c" 2
# 1 "spriteSheet.h" 1
# 21 "spriteSheet.h"
...
# 6 "levelOne.c" 2
# 1 "missionImpossible.h" 1
# 20 "missionImpossible.h"
 ...
 *(volatile unsigned short*)0x400000A = 1<<14 | 1 << 2 | 27 << 8;

 loadPalette(levelOneCloserImagePal);

 DMANow(3, levelOneCloserImageTiles, &((charblock *)0x6000000)[0], (11424/2) | (1 << 31));
 DMANow(3, levelOneCloserImageMap, &((screenblock *)0x6000000)[30], (4096/2) | (1 << 31));

 DMANow(3, levelOneFurtherImageTiles, &((charblock *)0x6000000)[1], (9664/2) | (1 << 31));
 DMANow(3, levelOneFurtherImageMap, &((screenblock *)0x6000000)[27], (4096/2) | (1 << 31));

 DMANow(3, spriteSheetPal, ((unsigned short*)(0x5000200)), 16);
    ...
    playSoundA(missionImpossible, 773719, 11025);
...
void checkButtons() {
 ...
 if(!(((~(*(volatile unsigned int *)0x04000130) & ((1<<6)))) && ((~(*(volatile unsigned int *)0x04000130) & ((1<<7)))) && ((~(*(volatile unsigned int *)0x04000130) & ((1<<5)))) && ((~(*(volatile unsigned int *)0x04000130) & ((1<<4)))))) {
 ...
 if((~(*(volatile unsigned int *)0x04000130) & ((1<<6)))) {
  ...
  playSoundB(dodgingSound, 38789, 11025);
 }
 ...
 *(volatile unsigned short *)0x04000016 = vOff+45;
...
void drawSprites() {
 shadowOAM[4].attr0 = (0 << 14) | player.row;
 shadowOAM[4].attr1 = (2 << 14) | player.col;
 shadowOAM[4].attr2 = (player.currFrame*2)*32+(player.aniState*4);
 DMANow(3, &shadowOAM[0], ((OBJ_ATTR*)(0x7000000)), (128*4));
 ...
 if(biker.alive == 1) {
  ...
  if(biker.col < 0) {
   ...
   shadowOAM[0].attr0 = (0 << 14) | biker.row;
   shadowOAM[0].attr1 = (2 << 14) | biker.col;
   shadowOAM[0].attr2 = (0)*32+(20);
  }
 }
 ...
 if(flyer1.alive == 1) {
  ...
  if(flyer1.col < 0) {
   ...
   shadowOAM[1].attr0 = (0 << 14) | flyer1.row;
   shadowOAM[1].attr1 = (2 << 14) | flyer1.col;
   shadowOAM[1].attr2 = (8)*32+(24);
  }
 }
 ...
 if(flyer2.alive == 1) {
  ...
  if(flyer2.col < 0) {
   ...
   shadowOAM[2].attr0 = (0 << 14) | flyer2.row;
   shadowOAM[2].attr1 = (2 << 14) | flyer2.col;
   shadowOAM[2].attr2 = (12)*32+(24);
  }
 }
}
