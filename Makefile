...
SOURCES            = main.c myLib.c splash.c splashImage.c l1Instructions.c l1InstructionsImage.c levelOne.c levelOneCloserImage.c levelOneFurtherImage.c pause.c pauseImage.c l1Win.c l1WinImage.c l1Lose.c l1LoseImage.c l2Instructions.c l2InstructionsImage.c levelTwo.c levelTwoImage.c l2Win.c l2WinImage.c l2Lose.c l2LoseImage.c spriteSheet.c dodgingSound.c missionImpossible.c goodRecruiterFound.c
